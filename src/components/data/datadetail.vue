  ...
  <div id="content">
    <div style="margin-top: 15px;margin-bottom:15px;width:350px;display:inline-block">
      <el-input placeholder="请输入内容" v-model="searchcontent" class="input-with-select">
        ...
        <el-button slot="append" icon="el-icon-search" @click="getmodledata"></el-button>
      </el-input>
    </div>
    ...
    <el-table :data="tableData" v-loading="loading" style="width: 100%" border empty-text="暂无数据">
      ...
      <el-table-column align="center" prop="add_time" label="添加时间" width="200"></el-table-column>
      <el-table-column align="center" prop="devicekw" label="设备功率"></el-table-column>
      <el-table-column align="center" prop="maxelev" label="电压/v"></el-table-column>
      <el-table-column align="center" prop="maxelei" label="电流/A"></el-table-column>
      <el-table-column align="center" prop="dataall" label="数据总用量"></el-table-column>
      <el-table-column align="center" prop="data" label="电量"></el-table-column>
      <el-table-column align="center" prop="runtime" label="运行时间/s"></el-table-column>
      <el-table-column align="center" prop="sleeptime" label="静止时间/s"></el-table-column>
      <el-table-column align="center" prop="closetime" label="关机时间/s"></el-table-column>
...
<script>
import { getTerminalData } from '../../api/api.js'
export default {
  name: 'DataDetail',
  data () {
    return {
  ...
  methods: {
    getmodledata: function (parmas) {
      var _this = this
      _this.loading = true
      if (_this.searchname !== '') {
        parmas[_this.searchname] = _this.searchcontent
      }
      getTerminalData(parmas)
        .then(response => {
