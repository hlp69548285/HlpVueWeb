<template>
  <div id='content'>
    ...
    <el-form ref="form" :rules="rules" :model="form" label-width="80px">
      <el-form-item label="编号" prop="terminalnum">
        <el-input v-model="form.terminalnum"></el-input>
      </el-form-item>
      <el-form-item label="网络ID" prop="netid">
        <el-input v-model.number="form.netid"></el-input>
      </el-form-item>
      <el-form-item label="模块ID" prop="modid">
        <el-input v-model.number="form.modid"></el-input>
      </el-form-item>
...
<script>
import { getDevice, addTerminal, getGateway } from '../../api/api.js'
export default {
  name: 'TerminalAdd',
  data () {
    return {
